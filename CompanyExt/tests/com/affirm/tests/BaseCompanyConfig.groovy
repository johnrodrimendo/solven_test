...
import com.affirm.system.configuration.SpringCompanyExtConfiguration
...
@ContextConfiguration(classes = [SpringRootConfiguration.class, SpringClientConfiguration.class, SpringCompanyExtConfiguration.class])
abstract class BaseCompanyConfig extends HttpCompanyConfig {
