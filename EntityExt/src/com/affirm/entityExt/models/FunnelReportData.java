...
public class FunnelReportData {
    ...
    public static class SideReport {
        ...
        public List<Step> getStepsWithoutVisits() {
            return steps != null ? steps.stream().filter(e -> e.getNumber() != -1).collect(Collectors.toList()) : new ArrayList<>();
        }
