...
import com.affirm.system.configuration.SpringAcquisitionConfiguration
...
@ContextConfiguration(classes = [SpringRootConfiguration.class, SpringClientConfiguration.class, SpringAcquisitionConfiguration.class])
abstract class BaseAcquisitionConfig extends HttpAcquisitionConfig{
