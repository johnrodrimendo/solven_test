...
import com.affirm.system.configuration.SpringLandingConfiguration
...
@ContextConfiguration(classes = [SpringRootConfiguration.class, SpringClientConfiguration.class, SpringLandingConfiguration.class])
abstract class BaseLandingConfig extends HttpLandingConfig{
