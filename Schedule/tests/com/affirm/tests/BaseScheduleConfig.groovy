...
import com.affirm.system.configuration.SpringScheduleConfiguration
...
@ContextConfiguration(classes = [SpringRootConfiguration.class, SpringScheduleConfiguration.class])
abstract class BaseScheduleConfig {
