 ...
 */
public class LoanApplicationBoPainter extends LoanApplication {
    ...
    PersonInteractionPainter interactions;
    ...
    public void fillFromDb(JSONObject json, CatalogService catalog, Locale locale, SysUserService sysUserService) throws Exception {
        ...
        if (JsonUtil.getIntFromJson(json, "credit_analyst_sysuser_id", null) != null) {
            setCreditAnalyst(sysUserService.getSysUserById(getCreditAnalystSysUserId()));
        }
    }
