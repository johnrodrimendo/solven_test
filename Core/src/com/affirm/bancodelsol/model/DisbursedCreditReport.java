...
public class DisbursedCreditReport {

    private Date registerDate;
    private Date creditDisbursementDate;
    ...
    public void fillFromDb(JSONObject json, CatalogService catalog, Locale locale) {
        setRegisterDate(JsonUtil.getPostgresDateFromJson(json, "la_register_date", null));
        setCreditDisbursementDate(JsonUtil.getPostgresDateFromJson(json, "originated_disbursed", null));
    ...
    public Date getCreditDisbursementDate() {
        return creditDisbursementDate;
    }

    public void setCreditDisbursementDate(Date creditDisbursementDate) {
    ...
    public void setInactiveWOScheduleDate(Date inactiveWOScheduleDate) { this.inactiveWOScheduleDate = inactiveWOScheduleDate; }
