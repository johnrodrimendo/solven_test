...
@Service("question61Service")
public class Question61Service extends AbstractQuestionService<AddressForm> {
        ...
        switch (flowType) {
            case LOANAPPLICATION:
                ...
                if(loanApplication.getCountryId().equals(CountryParam.COUNTRY_PERU)){
                    ...
                    personDao.updateOcupationalAddress(loanApplication.getPersonId(), ocupation.getNumber(), form.getRoadName(), form.getHomeAddress(), form.getDistrito());
                }
                break;
        }
    }
