...
@Service("question28Service")
public class Question28Service extends AbstractQuestionService<Question28Form> {
    ...
    public Map<String, Object> getViewAttributes(QuestionFlowService.Type flowType, Integer id, Locale locale, boolean fillSavedData, Map<String, Object> params) throws Exception {
        ...
        switch (flowType) {
            case LOANAPPLICATION:
                ...
                ((Question28Form.Validator) form.getValidator()).configValidator(loanApplication.getCountryId());
    ...
    @Override
    public String getQuestionResultToGo(QuestionFlowService.Type flowType, Integer id, Question28Form form) throws Exception {
        switch (flowType) {
            case LOANAPPLICATION:
                return "DEFAULT";
        }
    ...
    @Override
    protected void validateForm(QuestionFlowService.Type flowType, Integer id, Question28Form form, Locale locale) throws Exception {
        switch (flowType) {
            case LOANAPPLICATION:
                LoanApplication loanApplication = loanApplicationDao.getLoanApplication(id, Configuration.getDefaultLocale());
                ((Question28Form.Validator) form.getValidator()).configValidator(loanApplication.getCountryId());
    ...
    @Override
    public void saveData(QuestionFlowService.Type flowType, Integer id, Question28Form form, Locale locale) throws Exception {
        switch (flowType) {
            case LOANAPPLICATION:
                LoanApplication loanApplication = loanApplicationDao.getLoanApplication(id, Configuration.getDefaultLocale());
                registerPhoneNumber(
