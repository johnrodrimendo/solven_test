...
public class Question91Form extends FormGeneric implements Serializable {

    private String startDate;

    public Question91Form() {
        this.setValidator(new Question91Form.Validator());
    }
