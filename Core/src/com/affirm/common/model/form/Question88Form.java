...
public class Question88Form extends FormGeneric implements Serializable {

    private String startDate;

    public Question88Form() {
        this.setValidator(new Question88Form.Validator());
    }
