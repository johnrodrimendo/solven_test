...
public class RekognitionProResult implements Serializable {
    ...
    private RekognitionProData response;
    private Date registerDate;
    private Character status;


    public void fillFromDb(JSONObject json, CatalogService catalogService) {
        setId(JsonUtil.getIntFromJson(json, "rekognition_pro_result_id", null));
        ...
        if(JsonUtil.getJsonObjectFromJson(json, "response", null) != null){
            setResponse(new Gson().fromJson(JsonUtil.getJsonObjectFromJson(json, "response", null).toString(), RekognitionProData.class));
        }
    ...
    public RekognitionProData getResponse() {
        return response;
    }

    public void setResponse(RekognitionProData response) {
