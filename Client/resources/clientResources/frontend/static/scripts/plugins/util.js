...
function createFormValidationJson(jsonValidator, formElement, jsonFormValidationCustom) {
    var jsonFormValidation = {
        ...
        errorPlacement: function (error, element) {
            console.log(element,element.closest('form'), element.closest('.input-material'),'plugins');
            ...
            else if (element.closest('.input-material-outline').find(".errorContainer").length) {
                error.appendTo(element.closest('.input-material-outline').find(".errorContainer"));
            }
            else {
