...
const FgEmojiPicker = function (options) {
    ...
    this.init = () => {
        ...
        this.selectors.validatorTrigger = this.options.hasOwnProperty('validatorTrigger') ? this.options.validatorTrigger : "emoji-picker";
    ...
    this.bindEvents = () => {
      ...
      if(document.querySelector("body").classList.contains(this.selectors.validatorTrigger)) return;
      ...
      document.querySelector("body").classList.add(this.selectors.validatorTrigger);
    }
    ...
    this.functions = {
        ...
        emitEmoji(e) {
            ...
            if (el.tagName.toLowerCase() == 'a' && el.className.includes('fg-emoji-picker-item') && el.className.includes(this.selectors.validatorTrigger)) {
                e.preventDefault();
                            ...
                            <ul class="fg-emoji-picker-category ${index === 1 ? 'active' : ''}" id="${keyToId}" category-name="${key}">
                                ...
                                <div class="fg-emoji-picker-grid">`;
                                    ...
                                    categories.forEach(item => {
                                        innerLists += `<li data-name="${item.description.toLowerCase()}"><a class="fg-emoji-picker-item ${this.selectors.validatorTrigger}" title="${item.description}" data-name="${item.description.toLowerCase()}" data-code="${item.code}" href="${item.emoji}">${item.emoji}</a></li>`;
                                    });
                                    innerLists += `
                                </div>
                            </ul>`;
