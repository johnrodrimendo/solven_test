  ...
  !function o(e, t, n) {
    ...
    4: [function (n, o, a) {
      ...
      var r = function (e, t) {
        ...
        e.style.opacity = "", e.style.display = "flex";
      },
          c = function (e) {
...
$(document).on('ready', function () {
  ...
  closes.click(function (event) {
    ...
    console.log("class"); //$("#hamburger").removeClass('hamburger-none');
...
function check_if_in_view() {
  ...
  $.each(animation_elements, function () {
    ...
    } else {//element.removeClass('loaded');
    }
  });
} //modal


shutDown[0]; // When the user clicks the button, open the modal 
