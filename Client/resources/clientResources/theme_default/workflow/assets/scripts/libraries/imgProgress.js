(function( $ ) {
    ...
    $.fn.imgProgress = function(options) {
        ...
        //spanProgress.innerText = (percent)+' %';
        ...
        myClass.appendChild(spanProgress);
    ...
    $.fn.imgProgressTo = function(value) {
        if (value >= 0 && value <= 100) {
            ...
            var spanProgress = myClass.querySelector("span");
            circle.style.strokeDasharray = value + " 100";
            spanProgress.innerText = Math.round((value + 0.001) * 100) / 100 + ' %';
            return value;
        } else {
            return -1;
        }
