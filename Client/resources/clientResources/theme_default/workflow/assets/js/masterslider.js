...
;(function(window, document, $){
	...
	p.hideLayers = function () {
		...
		if( this.slide.selected || this.slider.options.instantStartLayers ){
			var that = this;
			that.layersHideTween = CTween.animate(this.$animLayers, 600, {opacity: 0}, {
				complete:function(){
					that._resetLayers();
				}
			});
			...
			if ( this.hasFixedLayer ) {
				this.fixedLayersHideTween = CTween.animate(this.$fixedLayers, 600, {opacity: 0}, {
					complete:function(){
...
;(function($){
	...
	p.__playVideo = function(){
		if(this.img)CTween.fadeOut(this.img , 600 , 2);
		CTween.fadeOut(this.video_btn , 600 , 2);
...
;(function(window, document, $){
    ...
    p.__playVideo = function (){
        ...
        CTween.fadeOut(this.vpbtn   , 600 , false);
        CTween.fadeIn(this.vcbtn    , 600);
        CTween.fadeIn(this.vframe   , 600);
    ...
    p.__closeVideo = function(){
        ...
        CTween.fadeIn(this.vpbtn    , 600);
        CTween.animate(this.vcbtn   , 600 , {opacity:0} , {complete:function(){ that.vcbtn.css  ('display'  , 'none'); }});
        CTween.animate(this.vframe  , 600 , {opacity:0} , {complete:function(){ that.vframe.attr('src'  , 'about:blank').css('display'  , 'none');}});
...
//
	...
	p.setHeight = function(value){
		if(this.options.smoothHeight){
			...
			this.htween = CTween.animate(this.slideController.view.$element , 600 , {height:value} , {ease:'easeOutQuart'});
		}else
